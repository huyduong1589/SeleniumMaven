...
import static core.matcher.SimpleResult.failure;
import static core.matcher.SimpleResult.success;

import java.util.Arrays;
import java.util.List;
import java.util.regex.Pattern;
import core.MultiResult;
import core.Result;
...
public final class Matchers {
     ...
     * <p/>
     * If the match succeeded, the input buffer is cleared and {@link core
     ...
     * <p/>
     * If succeeded, the {@link core.Result#getBefore()} will return the entire input
     * buffer, and
     * the {@link core.Result#group()} returns an empty string.
     *
     * @return the matcher
     */
     ...
     * <p/>
     * If the result is successful, the {@link core.Result#getBefore()} returns an
     * empty string, the
     * {@link core.Result#group()} returns the entire input buffer.
     *
     * @return the result
     */
     ...
     * <p/>
     * If the result is successful, the {@link core.Result#getBefore()} returns an
     * empty string, the {@link core.Result#group()} returns the entire input buffer.
     *
     ...
     * <p/>
     * If the result is successful, the {@link core.Result#getBefore()} returns an
     * empty string, the {@link core.Result#group()} returns the given string.
     *
